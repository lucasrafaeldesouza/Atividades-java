    ...
    public static void main(String[] args) {
        try {
            ...
            do {
                ...
                System.out.println(" [5] - INSERT - GOLFINHO (PreparedStatement)");
                System.out.println(" [6] - UPDATE - GOLFINHO (PreparedStatement)");
                System.out.println(" [7] - DELETE - GOLFINHO (PreparedStatement)");
                System.out.println(" [8] - SELECT - GOLFINHO (PreparedStatement)");
