public class SistemaPrincipal {
    public static void main(String[] args) {
        ...
        Padaria padariaUm = new Padaria(1, "Padaria Pao Doce Pao", "05/11/2001", 1, 89200105, "Rua olinda", 746,
                "Guanabara", "Porto Alegre");
        Padaria padariaDois = new Padaria(2, "Padaria Srze", "15/02/2005", 2, 89200105, "Rua paranaue", 456, "Humaita",
                "Rio de janerio");
        Padaria padariaTres = new Padaria(3, "Padaria ferragem", "16/04/2007", 3, 89200105, "Rua do irineu", 101,
                "Rocinha", "Curitiba");

        // Criando receitas para adicionar em chef e padaria
        Receita receitaUm = new Receita(20, "Pao",
                "Coloque em uma vasilha os ingredientes, misture bem e depois leve ao forno", 3, "R$0,50");
        ...
        Receita receitaOnze = new Receita(80, "orelha de gato", "misturar os ingredientes e colocar no forno", 2,
                "R$1,50");
        ...
        Mercado mercadoUm = new Mercado(400, "Economia", "11/04/2001", "Promocao pague 2 leve 3", 2011, 899114564,
                "Rua piratuba", 3600, "jardim iririu", "Garuva");
        Mercado mercadoDois = new Mercado(500, "Grão para", "07/02/1951",
                "Na compra de um abacaxi o segundo voce leva de graca", 1003, 85546555, "Rua Pedro sampaio", 315,
                "cruzeiro", "Santo andre");
        Mercado mercadoTres = new Mercado(600, "Benvenutti", "15/05/2001", "Churrasco em promocao no corredor quatro",
                9841, 55512346, "Rua uruguaiana", 715, "santo amaro", "Minas gerais");
